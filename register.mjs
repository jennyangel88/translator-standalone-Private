...
const cmds=[
  {name:'translate', description:'Auto-detect → translate ke Indonesia', type:1, options:[{name:'text', description:'Teks apapun', type:3, required:true},{name:'target', description:'Target', type:3, required:false, choices:[{name:'Indonesia',value:'id'},{name:'English',value:'en'},{name:'Korea',value:'ko'},{name:'Jepang',value:'ja'}]}]},
